...
def parse_opts():
    ...
    parser.add_argument('--annotation_path', default='data_preprocessing/annotations.txt', type=str,
    ...
    parser.add_argument('--pretrain_path', default='EfficientFace_Trained_on_AffectNet7.pth.tar', type=str,
